    ...
    <div className="flex flex-col gap-4">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          <label htmlFor="format" className="text-sm text-slate-600">
            Format:
          </label>
          <select
            id="format"
            ...
            className="bg-white border border-slate-300 text-slate-700 rounded-md px-3 py-1 text-sm"
      ...
      <div className="relative">
        <div className="absolute right-3 top-3 z-10 flex gap-2">
          <button 
            className="bg-slate-700 hover:bg-slate-800 text-white p-1.5 rounded-md flex items-center justify-center"
            title="Format code"
